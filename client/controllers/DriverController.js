...
socket.on('newCustomerMessage',function(data){
  console.log(data);
  document.getElementById("customerNameContainer").innerHTML=data.message.name
  ...
  document.getElementById("customerMailContainer").innerHTML=data.message.mail
  // document.getElementById("customerTypeContainer").innerHTML=data.message.cabtype
...
var k,name,carno,carname,email,contactno,sockid;
    ...
    // alert(sockid);
                            ...
                            for(k=0;k<$scope.driverlist.length;k++)
                      {
                        ...
                        console.log($scope.driverlist[k].Email);
