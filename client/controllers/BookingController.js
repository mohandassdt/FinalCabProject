...
for(m=0;m<details.length;m++){
        if(details[m].type==$scope.bokc.Type){
...
var loggedInUser;
  var authUser = $cookies.getObject('authUser');
        ...
        if (authUser != undefined) {
          ...
          $scope.NewDriver=false;

          socket.on('newDriverMessage',function(data) {

            console.log(data);

            document.getElementById("YourdriverDetailsName").innerHTML=data.driverNewDetails.fname
            document.getElementById("YourdriverDetailsmail").innerHTML=data.driverNewDetails.email
            document.getElementById("YourdriverDetails").innerHTML=data.driverNewDetails.mobile
...
var m;
  ...
  alert("You Cab Booked..... Driver Details will come soon");
  $scope.hideMap=false;
